...
class SubCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('vendor.products.subcategory.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('vendor.products.subcategory.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('vendorsubcategories.index'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('vendor.products.subcategory.edit', $data);
    }
