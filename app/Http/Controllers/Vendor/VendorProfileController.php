...
class VendorProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('vendor.profiles.profile', $data);
    }
    ...
    public function edit()
    {
        ...
        return view('vendor.profiles.profile_edit', $data);
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $admin->store_address    = $request->store_address;
            $admin->activity_type    = $request->activity_type;
    ...
    {
        return view('vendor.profiles.setting');
    }
