...
@section('body')
    ...
    <section class="py-5 bg-white">
        <div class="container py-lg-3">
            <div class="service-text-banner d-flex justify-content-center" style="background-image: url({{ asset('nsseb_assets/media/images/logistics-text-banner.png'); }})">
                <div class="text-box">
                    <img class="img-fluid mt-3" src="{{ asset('nsseb_assets/media/images/service-text-title-img.png') }}" alt="img">
                    <p class="mt-5 mb-5">@lang('home.logistics_article')</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-5">
                    <div class="service-box text-center">
                        ...
                        <p class="pt-5">@lang('home.logistics_text1')</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-5">
                    <div class="service-box text-center">
                        ...
                        <p class="pt-5">@lang('home.logistics_text2')</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-5">
                    <div class="service-box text-center">
                        ...
                        <p class="pt-5">@lang('home.logistics_text3')</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-5">
                    <div class="service-box text-center">
                        ...
                        <p class="pt-5">@lang('home.logistics_text4')</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-5">
                    <div class="service-box text-center">
                        ...
                        <p class="pt-5">@lang('home.logistics_text5')</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-5">
                    <div class="service-box text-center">
                        ...
                        <p class="pt-5">@lang('home.logistics_text6')</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-5">
                    <div class="service-box text-center">
                        ...
                        <p class="pt-5">@lang('home.logistics_text7')</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-5">
                    <div class="service-box text-center">
                        ...
                        <p class="pt-5">@lang('home.logistics_text8')</p>
                    </div>
                </div>
            </div>
