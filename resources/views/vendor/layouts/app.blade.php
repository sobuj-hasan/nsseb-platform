        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="" class="logo">
                        <span>
                            <h4 class="text-white pt-2"><strong>{{ Auth::user()->store_name }}</strong></h4>
                        </span>
                        <i>
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown notification-list">
                            <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                               ...
                               {{ Auth::user()->name }}
                                <img src="{{ asset('nsseb_assets/media/images/profile_img') }}/{{ Auth::user()->profile_photo }}" alt="user" class="rounded-circle">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown " aria-labelledby="Preview">
                                ...
                                <!-- item-->
                                <a href="{{ route('vendor.setting') }}" class="dropdown-item notify-item">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('vendorcategories.create') }}">Add New</a></li>
                                    <li><a href="{{ route('vendorcategories.index') }}">View List</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="javascript: void(0);"><i class="fa-solid fa-bars"></i> <span>Sub-Category</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('vendorsubcategories.create') }}">Add New</a></li>
                                    <li><a href="{{ route('vendorsubcategories.index') }}">View List</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="javascript: void(0);"><i class="far fa-copyright"></i> <span> Brand </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('vendorbrands.create') }}">Add New</a></li>
                                    <li><a href="{{ route('vendorbrands.index') }}">View List</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="javascript: void(0);"><i class="fab fa-product-hunt"></i> <span>My Products</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('vendorproducts.create') }}">Add New</a></li>
                                    <li><a href="{{ route('vendorproducts.index') }}">View All</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('myorder.index') }}"> Processing Order </a></li>
                                    <li><a href="{{ route('myorder.create') }}"> Cancle Order </a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="javascript: void(0);"><i class="fas fa-chevron-left"></i> <span>Back Website</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('index') }}">Main Website</a></li>
                                </ul>
                            </li>
