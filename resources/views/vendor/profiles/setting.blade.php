...
@section('content')
 ...
 <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    <h4 class="m-t-0 m-b-30 header-title">Setting <a class="btn btn-primary btn-xs float-right" href="{{ route('vendor.profile') }}" title=""> Back Profile </a></h4>
                    
                      <form action="{{ route('vendor.setting.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <a class="btn btn-sm btn-info" href="{{ route('vendor.profile') }}">Back Profile</a>
                    </form>
                </div>
            </div>
        </div>
