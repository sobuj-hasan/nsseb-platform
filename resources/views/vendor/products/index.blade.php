                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('vendorproducts.show', $product->id) }}">{{ $product->name }}</a>
                                        </td>
                                        <td>
                                        ...
                                        <form method="POST" action="{{ route('vendorproducts.destroy', $product->id) }}">
                                            @csrf
                                            @method('DELETE')
                                            <td>
                                                <a href="{{ route('vendorproducts.edit', $product->id) }}" class="table-action-btn"><i class="far fa-edit"></i></a>
