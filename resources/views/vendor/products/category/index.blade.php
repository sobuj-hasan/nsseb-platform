                            ...
                            <tbody>
                                @foreach ($categories as $categorie)
                                    <tr>
                                        ...
                                        <form method="POST" action="{{ route('vendorcategories.destroy', $categorie->id) }}">
                                            @csrf
                                            @method('DELETE')
                                            <td>
                                                <a href="{{ route('vendorcategories.edit', $categorie->id) }}" class="table-action-btn"><i class="far fa-edit"></i></a>
