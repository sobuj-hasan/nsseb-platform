                            ...
                            <tbody>
                                @foreach ($subcategories as $categorie)
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="m-b-0 m-t-0 font-600">{{ $categorie->category->name }}</h5>
                                        </td>
                                        <td>
                                        ...
                                        <form method="POST" action="{{ route('vendorsubcategories.destroy', $categorie->id) }}">
                                            @csrf
                                            @method('DELETE')
                                            <td>
                                                <a href="{{ route('vendorsubcategories.edit', $categorie->id) }}" class="table-action-btn"><i class="far fa-edit"></i></a>
