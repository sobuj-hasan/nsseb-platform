    ...
    <header id="header" class="main-wrapper">
        <div class="banner-img">
            <div class="banner-overlay">
                <div class="container">
                    <div class="header-div header-div-register-form">
    ...
    <div id="from-one" class="from-one main-wrapper">
        <div class="from-one-step">
            <div class="container">
                ...
                <form id="information_form" method="POST" action="{{ route('profile.update', $profile->id) }}">
                    @csrf
                    @method('PATCH')
                    <div class="tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" placeholder="name here" value="{{ $profile->full_name }}" name="full_name" required>
                                                </div>
                                                @error('full_name')
                                                ...
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="email" placeholder="email here" value="{{ $profile->email }}" name="email" required>
                                                </div>
                                                @error('email')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <select id="inputState" class="custom-input" name="gender" required>
                                                        <option class="option-text mute" value="{{ $profile->gender }}" selected> {{ $profile->gender }} </option>
                                                ...
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="phone" value="{{ $profile->phone }}" placeholder="+966 " name="phone" required>
                                                </div>
                                                @error('phone')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" placeholder="DD/MM/Year" value="{{ $profile->birth_date }}" name="birth_date" required>
                                                </div>
                                                @error('birth_date')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <select id="inputState" class="custom-input" name="age">
                                                        <option class="option-text" value="{{ $profile->age }}" selected> {{ $profile->age }} </option>
                                                ...
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" value="{{ $profile->religion }}" placeholder="religion" name="religion" required>
                                                </div>
                                                @error('religion')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" value="{{ $profile->mother_tongue }}" placeholder="mother tongue" name="mother_tongue" required>
                                                </div>
                                                @error('mother_tongue')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" value="{{ $profile->country }}" placeholder="country name" name="country" required>
                                                </div>
                                                @error('country')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <select id="inputState" class="custom-input" name="merital_status" required>
                                                        <option class="option-text mute" value="{{ $profile->merital_status }}" selected> {{ $profile->merital_status }} </option>
                                                ...
                                                <div class="name-input">
                                                    ...
                                                    <select id="inputState" class="custom-input" name="blood" required>
                                                        <option class="option-text mute" value="{{ $profile->blood }}" selected> {{ $profile->blood }} </option>
                                                ...
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" value="{{ $profile->annual_income }}"placeholder="ex.20000+ SAR" name="annual_income" required>
                                                </div>
                                                @error('annual_income')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <textarea style="height: 180px;" class="custom-input" placeholder="write something about you.." name="your_about" required>{{ $profile->your_about }}</textarea>
                                                </div>
                                                @error('your_about')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                            ...
                                            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                                <div class="name-input">
                                                    ...
                                                    <select id="inputState" class="custom-input" name="education" required>
                                                        <option class="option-text mute" value="{{ $profile->education }}" selected> {{ $profile->education }} </option>
                                                ...
                                                <div class="name-input">
                                                    ...
                                                    <select id="inputState" class="custom-input" name="height" required>
                                                        <option class="option-text mute" value="{{ $profile->height }}" selected> {{ $profile->height }} </option>
                                                ...
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" placeholder="ex. 70 kg" value="{{ $profile->weight }}" name="weight" required>
                                                </div>
                                                @error('weight')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" placeholder="ex. PANTONE 53-7C" value="{{ $profile->skin_tune }}" name="skin_tune" required>
                                                </div>
                                                @error('skin_tune')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <select id="inputState" class="custom-input" name="eay_color" required>
                                                        <option class="option-text" value="{{ $profile->eay_color }}" selected> {{ $profile->eay_color }} </option>
                                                ...
                                                <div class="name-input">
                                                    ...
                                                    <select id="inputState" class="custom-input" name="hear_color" required>
                                                        <option class="option-text" value="{{ $profile->hear_color }}" selected> {{ $profile->hear_color }} </option>
                                                        <option class="option-text" value="Brown"> Brown </option>
                                                ...
                                                <div class="name-input">
                                                    ...
                                                    <select id="inputState" class="custom-input" name="body_type" required>
                                                        <option class="option-text" value="{{ $profile->body_type }}" selected> {{ $profile->body_type }} </option>
                                                ...
                                                <div class="name-input">
                                                    ...
                                                    <select id="inputState" class="custom-input" name="family_type" required>
                                                        <option class="option-text" value="{{ $profile->family_type }}" selected> {{ $profile->family_type }} </option>
                                                ...
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" value="{{ $profile->family_status }}" placeholder="rich, poor or something" name="family_status" required>
                                                </div>
                                                @error('family_status')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" value="{{ $profile->occupation }}" placeholder="occupation" name="occupation">
                                                </div>
                                                @error('occupation')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" value="{{ $profile->disability }}" placeholder="disability" name="disability">
                                                </div>
                                                @error('disability')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" value="{{ $profile->hobby }}" placeholder="your hobby" name="hobby">
                                                </div>
                                                @error('hobby')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" value="{{ $profile->habits }}" placeholder="your habits" name="habits">
                                                </div>
                                                @error('habits')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    ...
                                                    <input class="custom-input" type="text" value="{{ $profile->per_country }}" placeholder="country" name="per_country" required>
                                                </div>
                                                @error('per_country')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    <input class="custom-input" type="text" value="{{ $profile->per_state }}" placeholder="state" name="per_state" required>
                                                </div>
                                                @error('per_state')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    <input class="custom-input" type="text" value="{{ $profile->per_city }}" placeholder="city" name="per_city" required>
                                                </div>
                                                @error('per_city')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    <input class="custom-input" type="text" value="{{ $profile->per_road }}" placeholder="road/area code" name="per_road" required>
                                                </div>
                                                @error('per_road')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    <textarea style="height: 120px;" class="custom-input" placeholder="House No, Building" name="per_house" required>{{ $profile->per_house }}</textarea>
                                                </div>
                                                @error('per_house')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    <div class="name-input per-address">
                                                        ...
                                                        <input class="custom-input" type="text" value="{{ $profile->present_country }}" placeholder="country" name="present_country" required>
                                                    </div>
                                                </div>
                                                ...
                                                @enderror
                                                <div class="name-input">
                                                    <input class="custom-input" value="{{ $profile->peresent_state }}" type="text" placeholder="state" name="peresent_state" required>
                                                </div>
                                                @error('present_state')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    <input class="custom-input" type="text" value="{{ $profile->present_city }}" placeholder="city" name="present_city" required>
                                                </div>
                                                @error('present_city')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    <input class="custom-input" type="text" value="{{ $profile->present_road }}" placeholder="Road/area code" name="present_road" required>
                                                </div>
                                                @error('present_road')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
                                                <div class="name-input">
                                                    <textarea style="height: 120px;" class="custom-input" placeholder="House No, Building" name="present_house" required>{{ $profile->present_house }}</textarea>
                                                </div>
                                                @error('present_house')
                                                    <small style="margin-left: 30px;" class="text-danger">{{ $message }}</small>
                                                @enderror
