        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="" class="logo">
                        <span>
                            <h4 class="text-white pt-2"><strong>Nsseb Admin</strong></h4>
                        </span>
                        <i>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('subcategories.create') }}">Add New</a></li>
                                    <li><a href="{{ route('subcategories.index') }}">View List</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="{{ route('brands.index') }}">View List</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('orders.index') }}"> Processing Order </a></li>
                                    <li><a href="{{ route('orders.create') }}"> Cancle Order </a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="javascript: void(0);"><i class="fa-solid fa-handshake-angle"></i> <span> Service Request </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('request.index') }}">View All</a></li>
                                </ul>
                            </li>
