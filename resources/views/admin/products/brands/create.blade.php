                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('brands.store') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="field-1" placeholder="Brand name" name="name" value="{{ old('name') }}" required>
                                        @error('name')
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('brands.index') }}" type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Cancel</a>
